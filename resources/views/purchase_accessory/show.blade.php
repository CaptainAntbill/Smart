    ...
    <div class="container">
        <div class="notification">
            <div class="columns">
                ...
                <div class="column ">
                    <a class="button is-info is-three-half" href="{{ route('purchase_accessory.edit', $purchases->id) }}">Editar Informacion</a>
                    <a class="button is-info is-pulled-right" href="{{ route('purchase_accessory.index') }}"> Ir a Lista</a>
                </div>
            </div>
