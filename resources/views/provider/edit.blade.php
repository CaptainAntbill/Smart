        ...
        <div class="notification">
            <form action="{{ route('provider.update', $providers->id) }}" method="post">
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input type="text" name="name" class="input" value=" {{ $providers->name }}" required pattern="[a-zA-Z0-9_ ]{5,50}$">
                    </div>
                </div>
                <div class="field">
                    <label for="name" class="label">Direccion</label>
                    <div class="control">
                        <input type="text" name="addres" class="input" value=" {{ $providers->addres }}" required pattern="[a-zA-Z0-9_ ]{5,50}$">
                    </div>
                </div>
                <div class="field">
                    <label for="punteo" class="label">Telefono</label>
                    <div class="control">
                        <input type="text" name="phone" value="{{ $providers->phone }}" class="input" required ">
                </div>
            </div>
            <div class=" field">
                        <div class="control">
